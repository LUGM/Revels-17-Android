...
public class EasterEggActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView lugFBIcon = (ImageView)findViewById(R.id.lug_fb_icon);
        TextView lugFBLink = (TextView)findViewById(R.id.lug_fb_link);

        View.OnClickListener lugFBOnClickListener = new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                openLink(LUG_FB);
            }
        ...
        lugFBIcon.setOnClickListener(lugFBOnClickListener);
        lugFBLink.setOnClickListener(lugFBOnClickListener);

        ImageView lugGitIcon = (ImageView)findViewById(R.id.lug_github_icon);
        TextView lugGitLink = (TextView)findViewById(R.id.lug_github_link);

        View.OnClickListener lugGitOnClickListener = new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                openLink(LUG_GITHUB);
            }
        ...
        lugGitIcon.setOnClickListener(lugGitOnClickListener);
        lugGitLink.setOnClickListener(lugGitOnClickListener);
    }
