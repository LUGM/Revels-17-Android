...
import in.revels.revels.fragments.CategoriesFragment;
import in.revels.revels.fragments.EventsFragment;
import in.revels.revels.fragments.FavouritesFragment;
import in.revels.revels.fragments.InstaFeedFragment;
import in.revels.revels.fragments.ResultsFragment;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private static final String INSTAFEED_TAG = "InstaFeed Fragment";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getResources().getString(R.string.revels17));
            ...
            public void run() {
                ...
                switch(item.getItemId()){
                    ...
                    case R.id.drawer_menu_insta:
                        if (fm.findFragmentByTag(INSTAFEED_TAG) == null) {
                            fm.beginTransaction().setCustomAnimations(R.anim.slide_in_from_top, R.anim.blank).replace(R.id.main_container, new InstaFeedFragment(), INSTAFEED_TAG).commit();
                        }
                        else{
                            fm.beginTransaction().setCustomAnimations(R.anim.slide_in_from_top, R.anim.blank).replace(R.id.main_container, fm.findFragmentByTag(INSTAFEED_TAG)).commit();
                        }
